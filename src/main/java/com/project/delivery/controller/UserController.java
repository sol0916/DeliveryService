...
import com.project.delivery.user.service.UserService;
import com.project.delivery.util.Criteria;
import com.project.delivery.util.PageVO;
...
public class UserController {
	...
	public String resist(UserVO vo,
		...
		if(vo.getUser_type().equals("관리자")) {
			...
			ArrayList<UserVO> list = userService.getAdminUser_no();
			
			int index = list.get(0).getUser_no();
			...
			if(index<101) {
				...
				ra.addFlashAttribute("msg", "관리자 번호는 100번까지만 생성 가능합니다");
	...
	public String adminList(UserVO vo ,Model model, Criteria cri) {
	...
	public String deliverList(UserVO vo, Model model, Criteria cri) {
